...
//--------主要功能函数-------------------------------------------------------
// 初始化函数
SI4432_EXT void 	Si4432PortInit(void) 					reentrant;		//Si4432端口初始化 
SI4432_EXT void 	Si4432VariInit(void) 					reentrant;		//Si4432全局变量初始化
SI4432_EXT SI4432DCB* Si4432GetDCB(void)					reentrant;		//设备设备控制参数
...
SI4432_EXT void 	Si4432Open(void) 						reentrant;		//打开Si4432电源
SI4432_EXT void 	Si4432Close(void) 						reentrant;		//关闭Si4432电源
SI4432_EXT void		Si4432Standby(void)  					reentrant;		//进入空闲状态
SI4432_EXT void 	Si4432Ready(void)  						reentrant;		//进入Ready状态
...
//发送接收相关函数
SI4432_EXT BOOL 	Si4432IsChannelClear(void)					reentrant;	//Si4432判断信道是否空闲
...
SI4432_EXT void 	Si4432SendCarryEnd(void) 					reentrant;	//停止发送载波，供测试用
SI4432_EXT uint8 	Si4432Receive(void) 						reentrant;	//Si4432接收程序
...
//端口引脚控制
void Si4432PortShut(void) reentrant;
void Si4432PortOpen(void) reentrant;
